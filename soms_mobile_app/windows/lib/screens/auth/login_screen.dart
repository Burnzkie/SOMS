                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [Color(0xFF5B5BF6), Color(0xFF9B5CF6)]),
                      borderRadius: BorderRadius.circular(16),
                    ),
                    child: const Text('S', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 22)),
                  ),
                  const SizedBox(height: 24),
                  Text('Welcome back', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700)),
                  const SizedBox(height: 6),
                  Text('Sign in with your Student ID to access SOMS.', style: Theme.of(context).textTheme.bodyMedium),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      counterText: '', // hides the default "0/11" counter widget — maxLength still enforced
                    ),
                    textInputAction: TextInputAction.next,
                    autocorrect: false,
                    textCapitalization: TextCapitalization.characters,
                    maxLength: 11, // hard cap — this is what was missing: nothing stopped typing past 11 before
                    inputFormatters: [
